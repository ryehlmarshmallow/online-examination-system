...
@AllArgsConstructor
@Builder
public class MultipleChoiceQuestionContent implements QuestionContent {
    ...
    public void verifyStructuralConsistency(QuestionContent incoming) {
        MultipleChoiceQuestionContent other = requireSameType(incoming);
    ...
    public QuestionContent deepCopy() {
        ...
        return MultipleChoiceQuestionContent.builder()
